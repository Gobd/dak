  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black p-4">
      ...
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-bold text-center mb-8 dark:text-white">Health Tracker</h1>
        {success ? (
          <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-sm p-6 text-center">
            <h2 className="text-lg font-semibold dark:text-white mb-2">Password Updated</h2>
          ...
          >
            <h2 className="text-lg font-semibold dark:text-white text-center">Set New Password</h2>
            <div>
