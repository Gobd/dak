...
from app.models.models import AlreadyDownloadedResponse, DeleteResponse, VoskModelInfo

logger = logging.getLogger(__name__)
router = APIRouter(prefix="/voice/models", tags=["models"])
...
@router.get("", response_model=list[VoskModelInfo])
...
@router.get("/{model_id}", response_model=VoskModelInfo)
