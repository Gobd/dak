...
// Universal Links will open the app on iOS/Android if installed,
// otherwise falls back to web (which also works)
...
function getRedirectUrl(path: string): string {
  ...
  // On native, always use production URL (Universal Links)
